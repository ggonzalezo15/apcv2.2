<?php
/**
 * API Endpoint para obtener estadísticas del sistema de archivos (SIN AUTENTICACIÓN - SOLO DEMO)
 * Endpoint: api/cleanup/get_stats_demo.php
 * Método: GET
 * NO requiere autenticación - SOLO PARA DEMOSTRACIÓN
 */
...
try {
    ...
    error_log("Error en get_stats_demo.php: " . $e->getMessage());
    ...
    error_log("Error general en get_stats_demo.php: " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
